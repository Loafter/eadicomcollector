...
//main srv class
type EaFolderCompressorSrc struct {
	fcom FolderCompressor
}

//start and init srv
func (srv *EaFolderCompressorSrc) Start(listenPort int) error {
...
func (srv *EaFolderCompressorSrc) index(rwr http.ResponseWriter, req *http.Request) {
...
func (service *EaFolderCompressorSrc) Redirect(responseWriter http.ResponseWriter, request *http.Request) {
	http.Redirect(responseWriter, request, "/index.html", 301)
}

//serve cEcho responce
func (srv *EaFolderCompressorSrc) Compress(rwr http.ResponseWriter, httpreq *http.Request) {
